...
> 当前版本：**v1.0**　·　如需查看其他版本，请打开同目录下对应的 `prd_v*.md` 文件。
...
| **全局原型** | [`../prototype/prototype_v1.0.html`](../prototype/prototype_v1.0.html) |
...
> **💡 新手提示**：这里是 PRD 的核心。每个功能点采用**"流程图 + 规则描述 + 原型链接"**的三段式结构。
> 原型链接带 Hash 锚点（如 `#login`），点击后直接跳转到原型对应页面，做到**"文档配画面"**。
