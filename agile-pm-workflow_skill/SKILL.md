...
description: "Guides novice PMs through a 7-step agile workflow: dialogue-based requirement gathering, drafting PRD skeleton (dual format: HTML + Word/docx for Feishu import), HTML prototype creation (via frontend-design), mermaid flowcharts with PNG export, and final PRD with iframe slices (HTML) and screenshots+links (Word)."
---
